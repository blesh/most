...
function scan(f, initial, stream) {
	 return new Stream(new Accumulate(ScanSink, true, f, initial, stream.source));
}
...
function reduce(f, initial, stream) {
	return runSource.withDefaultScheduler(noop, new Accumulate(AccumulateSink, false, f, initial, stream.source));
}

function Accumulate(SinkType, p, f, z, source) {
